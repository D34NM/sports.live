...
export function TeamIcon({
  ...
  return (
    <div
      className={`${sizeClass} ${colorClass} rounded-full flex items-center justify-center font-bold shadow-md relative overflow-hidden group`}
      title={teamName}
      role="img"
    ...
    >
      ...
      <span className="relative z-10 font-bold">{teamAbbreviation}</span>
    </div>
  );
}
