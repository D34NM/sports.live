...
<p class="text-lg text-gray-600 dark:text-gray-400">Watch NBA games without spoilers</p>
</header>
...
{isToday(selectedDate) ? "Today's Games" : `Games for ${formatDate(selectedDate)}`}
</h2>
...
>
<p class="font-semibold mb-2">Sports.Live - Your spoiler-free NBA companion</p>
