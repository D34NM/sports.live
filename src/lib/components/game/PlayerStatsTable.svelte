...
<div class="text-xs text-gray-500 dark:text-gray-400">{player.position}</div>
</div>
</div>
<div class="col-span-1 text-center font-semibold">{player.points}</div>
...
{calculateFGPercentage(player.fieldGoalsMade, player.fieldGoalsAttempted)}%
...
<div>
<div class="text-xs text-gray-500 dark:text-gray-400">3-Point</div>
...
<div>
<div class="text-xs text-gray-500 dark:text-gray-400">Free Throws</div>
<div class="font-semibold">
{player.freeThrowsMade}/{player.freeThrowsAttempted}
({calculateFGPercentage(player.freeThrowsMade, player.freeThrowsAttempted)}%)
</div>
</div>
<div>
<div class="text-xs text-gray-500 dark:text-gray-400">Turnovers</div>
<div class="font-semibold">{player.turnovers}</div>
</div>
<div>
<div class="text-xs text-gray-500 dark:text-gray-400">Fouls</div>
