...
<p class="text-lg text-gray-600 dark:text-gray-400 font-medium">Loading games...</p>
</div>
...
<p class="text-2xl font-bold text-gray-700 dark:text-gray-300 mb-2">No games scheduled</p>
<p class="text-gray-500 dark:text-gray-400">Check back later or browse other dates</p>
</div>
{:else}
